...
class Profile extends Base
{
    ...
    {
        parent::_initialize();
        $this->public_path = ROOT_PATH;
        $this->head_return_path = '/public/upload/head';
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $user_data = $user_model->getOneUser(session('user_id'));
            ...
            $flag = $user_model->updateStatus($param, session('user_id'));
    ...
    public function headEdit()
    {
        ...
        if ($this->request->isAJax()) {
            ...
            $user_model = new UserModel();
             ...
             Session::set('head',$param['head']);

            

            $flag = $user_model->save($param, ['user_id' => session('user_id')]);
            if ($flag) {
                $this->removRoleCache();
