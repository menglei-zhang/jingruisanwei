<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"/webdata/snake/application/admin/view/order/orderadd.html";i:1558854535;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div class="input-group col-sm-7">
                                    <div class="radio  col-sm-6">
                                        <?php if(is_array($shenchan) || $shenchan instanceof \think\Collection || $shenchan instanceof \think\Paginator): $k = 0; $__LIST__ = $shenchan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shenchan): $mod = ($k % 2 );++$k;?>
                                         <input type="radio" name="confirm" value="<?php echo $shenchan['id']; ?>" title="<?php echo $shenchan['group_name']; ?>" id="confirm"  >
