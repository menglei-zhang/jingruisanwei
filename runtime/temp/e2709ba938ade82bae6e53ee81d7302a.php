<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"/webdata/snake/application/admin/view/index/index.html";i:1558883055;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!-- <?php if($vo['role_id'] != '5' ||  $vo['role_id'] != '16'): ?>
 ...
 <div class="wrapper"> 
      ...
      <div class="main">
        ...
        <h1 style="margin-top: 100px;color: #999;margin-bottom: 5px;font-size: 70px;font-weight: 100;">欢迎使用</h1>
      ...
      <section class="page1">
        ...
        <div class="page_container">
          ...
          <h1><a href="http://www.jq22.com" target="_blank">Travel to Sydney, Australia<br><small>Completed on 14 Feb 2014</small></a></h1>
      ...
      <section class="page2">
        ...
        <div class="page_container">
          ...
          <h1><a href="http://www.jq22.com" target="_blank">Visit Uluru (Ayers Rock), Australia<br><small>Completed on 17 Feb 2014</small></a></h1>
      ...
      <section class="page3">
        ...
        <div class="page_container">
          ...
          <h1><a href="http://www.jq22.com" target="_blank">Travel to ZhangJiaJie (Avatar's Mountain) in China<br><small>Completed on 20 Jan 2014</small></a></h1>
      ...
      <section class="page4">
        ...
        <div class="page_container">
          ...
          <h1><a href="http://www.jq22.com" target="_blank">Ride a Camel in the Australian Outback<br><small>Completed on 17 Feb 2014</small></a></h1>
