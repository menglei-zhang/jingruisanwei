<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/Applications/MAMP/htdocs/www/jingruisanwei/application/admin/view/order/orderedit.html";i:1564545912;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                      ...
                      <ul class="layui-tab-title">
                        ...
                        <div class="layui-tab-content">
                           <div class="layui-tab-item layui-show">
                            ...
                            <?php if($vo['role_id'] == '1' or $vo['role_id'] == '3' or $vo['role_id'] == '4' or $vo['role_id'] == '5' or $vo['role_id'] == '13' or $vo['role_id'] == '16'): ?>
                             ...
                             <!-- 测试版本 -->
                                ...
                                <label class="col-sm-3 control-label ">*客户名称：</label>
                                    ...
                                    <div class="input-group col-sm-4">
                                      <select name="username" lay-verify="required" id="username" lay-search <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?> >
                                        <option value=""></option>
                                      <?php if(is_array($name) || $name instanceof \think\Collection || $name instanceof \think\Paginator): $k = 0; $__LIST__ = $name;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$name): $mod = ($k % 2 );++$k;?>
                                        ...
                                        <option value="<?php echo $name['cust_name']; ?>" <?php if($name['cust_name'] == $content['username']): ?>selected <?php endif; ?>><?php echo $name['cust_name']; ?> - <?php echo $name['cust_liaison']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <input id="place" type="text" class="form-control" name="place" required="" aria-required="true" value="<?php echo $content['place']; ?>"  <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                </div>
                            </div>
                            <?php endif; ?>
  ...
  <!--                           <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group col-sm-2">
                                <input type="text" name="update" id="update" autocomplete="off" class="layui-input" value="<?php echo $content['update']; ?>" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-7">
                                    <div class="radio  col-sm-6">
                                        ...
                                        <input type="radio" name="uptime" value="上午" title="上午" id="uptime"  <?php if($content['uptime'] == '上午'): ?> checked <?php endif; if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                    
                                        <input type="radio" name="uptime" value="下午" title="下午" id="uptime" <?php if($content['uptime'] == '下午'): ?> checked <?php endif; if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>

                                        <input type="radio" name="uptime" value="晚上" title="晚上" id="uptime" <?php if($content['uptime'] == '晚上'): ?> checked <?php endif; if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                    
                                    </div>

                                </div>
                            </div>
                            <?php if($vo['role_id'] != '13' || $vo['group_id'] == 24): ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">制作工艺：</label>
                                <div class="input-group col-sm-4">
                                    <input id="craft" type="text" class="form-control" name="craft" aria-required="true" value="<?php echo $content['craft']; ?>" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <input id="sanding" type="text" class="form-control" name="sanding" aria-required="true" value="<?php echo $content['sanding']; ?>" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-2">
                                    <input id="num" type="text" class="form-control" name="num" aria-required="true" value="<?php echo $content['num']; ?>" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-2">
                                    <input id="weight" type="text" class="form-control" name="weight" aria-required="true" value="<?php echo $content['weight']; ?>" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <input id="material" type="text" class="form-control" name="material" required="" aria-required="true" value="<?php echo $content['material']; ?>" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?>>
                                </div>
                            </div>   
                           ...
                           <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <textarea id="be_careful" name="be_careful" required lay-verify="required" placeholder="请输入" class="layui-textarea"  <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4' and $vo['role_id'] != 16): ?>disabled="disabled"<?php endif; ?> ><?php echo $content['be_careful']; ?></textarea>
                                </div>
                            </div>   
...
<!--                              <div class="form-group">
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="input-group col-sm-7">
                                       <div class="radio  col-sm-6" style="padding-top: 0; padding-left: 0;" id="p-top">
                                           <input type="radio" <?php if($vo['role_id'] == 4 or $vo['role_id'] == 16): ?>disabled<?php endif; ?> name="type" value="0" <?php if($content['type'] == 0): ?>checked<?php endif; ?> title="随机分配" lay-filter="type" >

                                           <input type="radio" <?php if($vo['role_id'] == 4 or $vo['role_id'] == 16): ?>disabled<?php endif; ?> name="type" value="1" <?php if($content['type'] == 1): ?>checked<?php endif; ?> title="指定人员" lay-filter="type" >
                                       </div>
                                   </div>
                               </div>
                          ...
                          <div class="form-group">
                                ...
                                <div class="input-group col-sm-7">
                                    <div class="radio  col-sm-6" style="padding-top: 0; padding-left: 0;" id="p-top">
                                        <?php if(is_array($shenchan) || $shenchan instanceof \think\Collection || $shenchan instanceof \think\Paginator): $k = 0; $__LIST__ = $shenchan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shenchan): $mod = ($k % 2 );++$k;?>
                                         <input type="radio" name="confirm" value="<?php echo $shenchan['id']; ?>" lay-filter="confirm" title="<?php echo $shenchan['group_name']; ?>" <?php if($vo['role_id'] == 4 or $vo['role_id'] == 16): ?>disabled<?php endif; ?> id="confirm"  <?php if($content['confirm'] == $shenchan['id']): ?>checked<?php endif; ?> >
                               ...
                               <div class="form-group" id="program_box" <?php if($userList): ?>style="display: block;"<?php endif; ?>>
                                   <label class="col-sm-3 control-label">*编程人员：</label>

                                   <div class="input-group col-sm-4">
                                       <select name="program" lay-verify="required" id="program" lay-search <?php if($vo['role_id'] == 4 or $vo['role_id'] == 16): ?>disabled<?php endif; ?>    >
                                            <option value="">请选择编程人员</option>
                                           ...
                                           <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $v['user_id']; ?>" <?php if($content['designation_user'] == $v['user_id']): ?>selected<?php endif; ?>><?php echo $v['user_name']; ?></option>
                                           <?php endforeach; endif; else: echo "" ;endif; ?>
                                       </select>
                                   </div>
                               </div>
                           ...
                           <!--  权限区域    暂时展示-->
                           <?php if(!in_array($vo['role_id'], [3, 4]) || (in_array($vo['role_id'], [3, 4]) && $vo['static'] > 2)): ?>
                           <div class="form-group">
                               <label class="col-sm-3 control-label">*编程人员：</label>
                               <div class="input-group col-sm-4">
                                   <input id="programmer" type="text" class="form-control" name="programmer" <?php if(in_array($vo['role_id'], [3, 4])): ?>  disabled <?php else: ?>required="" <?php endif; ?> aria-required="true" value="<?php echo $content['programmer']; ?>"  >
                               </div>
                           </div>
                           ...
                           <div class="form-group">
                               ...
                               <div class="input-group col-sm-4">
                                   <input id="machine_number" type="text" class="form-control" name="machine_number" <?php if(in_array($vo['role_id'], [3, 4])): ?>  disabled <?php else: ?>required="" <?php endif; ?> aria-required="true" value="<?php echo $content['machine_number']; ?>">
                               </div>
                           </div>
                           <div class="form-group">
                               <label class="col-sm-3 control-label">*下机日期：</label>
                               <div class="input-group col-sm-2">
                                   <input type="text" name="date" id="date1" autocomplete="off" class="layui-input" <?php if(in_array($vo['role_id'], [3, 4])): ?>  disabled <?php else: ?>required=""<?php endif; ?> value="<?php echo $content['date']; ?>">
                               </div>
                           </div>
                           <?php endif; ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group col-sm-2">
                                <input type="text" class="layui-input" value="<?php echo $content['overtime']; ?>" style="color:red" disabled="disabled">
                              </div> 
                            </div>
                          ...
                          <div class="layui-tab-item form-group" >
                           ...
                           <!--        <button type="button" class="layui-btn layui-btn layui-btn-radius" id="mess_img" style="float: right;margin: 19px;"> 
                             ...
                             <div class="form-group">   
                               <?php switch($vo['role_id']): case "3": if($content['static'] == '5'): ?>
                                ...
                                <div class="col-sm-4 col-sm-offset-5">
                                   ...
                                   <button class="btn btn-primary" id="btnSubmit"  type="submit" lay-filter="btnSubmit">确认提交</button>
                                    <a class="btn btn-primary" id="escSubmit"  onclick="escSubmit(<?php echo $content['id']; ?>,'4')">驳回订单</a>
                                ...
                                <div class="col-sm-4 col-sm-offset-5">
                                    <input type="hidden" name="static" value="2"/>
                                     <input type="hidden" name="role_id" value="<?php echo $vo['role_id']; ?>"/>
                                     <button class="btn btn-primary" id="btnSubmit"  type="submit" lay-filter="btnSubmit">确认提交</button>
                                    <a class="btn btn-primary" id="escSubmit"  onclick="escSubmit(<?php echo $content['id']; ?>,'3')">驳回订单</a>
                                </div> 
                                ...
                                <div class="col-sm-4 col-sm-offset-5">
                                    <input type="hidden" name="static" value="5"/>
                                     <input type="hidden" name="role_id" value="<?php echo $vo['role_id']; ?>"/>
                                     <button class="btn btn-primary" id="btnSubmit"  type="submit" lay-filter="btnSubmit">确认提交</button>
                                    <a class="btn btn-primary" id="escSubmit"  onclick="escSubmit(<?php echo $content['id']; ?>,'2')">驳回订单</a>
                                </div> 
                                <?php break; case "16": ?>
                                 <div class="col-sm-4 col-sm-offset-5">
                                     <input type="hidden" name="role_id" value="<?php echo $vo['role_id']; ?>"/>
                                     <button class="btn btn-primary" id="btnSubmit"  type="submit" lay-filter="btnSubmit">修改订单</button>
                                 </div>
                                 <?php break; endswitch; ?>
                            </div>
                ...
                , done: function (page, next) {            //到达临界，触发下一页
                  ...
                  layui.each(a, function(index, item){
                       ...
                       // console.log(fileExt);
                    	...
                    	var el = random(100,5000);
                        var le = random(20000,10000);           	  
                      if(index > 0){
                          ...
                          if(fileExt != 'jpg'){
                             ...
                             lis.push(['<tr id="upload-'+ index +'" >' ,
                               ...
                               '<td><?php echo $domain; ?>'+ item +'</td>'
                              ,'<td>'+ le +'</td>'
                              ,'<td>已上传</td>'
                              ,'<td><?php if($vo['role_id'] == 3 || $vo['role_id'] == 4): ?><a class="layui-btn layui-btn-xs layui-btn-danger demo-delete" onclick=urldelete("' + item + '")>删除</a><?php endif; ?><a class="layui-btn layui-btn-xs layui-btn-danger demo-delete" onclick=urlupload("/public' + item + '")  target="_blank">下载</a></td>'
                            ,'</tr>']);
...
<script type="text/javascript">
    $('.commentAll').on('click','.plBtn',function(){
        ...
        $.ajax({
          ...
          type: 'post',
          data: {"user_id": <?php echo \think\Session::get('user_id'); ?>,"mess_list": oSize,"add_time": now, "order_id": <?php echo $content['id']; ?>, "real_name": real_name, "head": head, "mess_img": arr},
          dataType: 'json',
          success: function (data) {
              console.log(data)
          },
