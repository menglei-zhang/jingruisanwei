<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/Applications/MAMP/htdocs/www/jingruisanwei/application/admin/view/role/index.html";i:1557994688;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>角色列表</h5>
             <hr>
            <h5 style="color:red">*注释：添加是添加职业角色，也即权限角色</h5>
