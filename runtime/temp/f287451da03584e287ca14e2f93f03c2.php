<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\wamp64\www\snake/application/admin\view\order\orderedit.html";i:1557395106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group col-sm-7">
                                    <div class="radio  col-sm-6">
                                        <input type="radio" name="confirm" value="3D打印" title="3D打印" id="confirm" checked <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4'): ?>disabled="disabled"<?php endif; ?>>
                                        <input type="radio" name="confirm" value="CNC" title="CNC" id="confirm" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4'): ?>disabled="disabled"<?php endif; ?>>
                                        <input type="radio" name="confirm" value="复模" title="复模" id="confirm" <?php if($vo['role_id'] != '1' and $vo['role_id'] != '3' and $vo['role_id'] != '4'): ?>disabled="disabled"<?php endif; ?>>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       layui.use('upload', function(){
          ...
          ,upload = layui.upload;
          var a = "<?php echo $content['pc_src']; ?>".split(",");
          //多文件列表
            ...
            flow.load({
                ...
                , done: function (page, next) {            //到达临界，触发下一页
                  ...
                  layui.each(a, function(index, item){
                      ...
                      ,'<td>'+ 1 +'kb</td>'
                      ,'<td>已上传</td>'
                      ,'<td><a class="layui-btn layui-btn-xs layui-btn-danger demo-delete" onclick=urldelete("' + item + '")>删除</a></td>'
                    ,'</tr>']);
