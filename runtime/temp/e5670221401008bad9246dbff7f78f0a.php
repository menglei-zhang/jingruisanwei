<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/jingrui.gugangkf.cn/application/admin/view/index.html";i:1562138703;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                      <li class="layui-nav-item">
                        <a href="<?php echo url('admin/view/index'); ?>" class="J_menuItem">消息提示<span class="layui-badge msg-num" id="countInfo" style="position: relative;display: inline-block;padding: 0 6px;font-size: 12px;text-align: center;background-color: #FF5722;color: #fff;border-radius: 2px;"><?php echo $countInfo; ?></span></a>
                      </li>
    ...
    <audio id="music">
        <source src="/public/__STATIC__/admin/audio/prompt.mp3" type="audio/mpeg">
        您的浏览器不支持 audio 元素。
    </audio>
</div>
...
<script>
    function resetMsgNum(){
       $.post("<?php echo url('admin/Index/index'); ?>",function(data){
         if( data !== ''){           
        	$('.msg-num').html(data);
      	}
     });
    ...
    function prompt(){
        ...
        $.ajax({
            ...
            type: 'POST',
            success(res){
                if(1 == res.data.prompt) {
                    audio.play();

                    $("#countInfo").html(res.data.count);

                    $.ajax({
                        url: '<?php echo url("index/Prompt/handle"); ?>',
                        headers: {
                            'content-type': 'application/x-www-form-urlencoded'
                        },
                        data: {},
