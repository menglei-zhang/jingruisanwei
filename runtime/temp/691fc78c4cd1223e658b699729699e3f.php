<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/jingrui.gugangkf.cn/application/admin/view/user/useradd.html";i:1530110214;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-8">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('user/useradd'); ?>">
