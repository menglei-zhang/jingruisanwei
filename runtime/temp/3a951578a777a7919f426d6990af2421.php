<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"/webdata/snake/application/admin/view/index.html";i:1558434894;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                      <li class="layui-nav-item">
                        <a href="<?php echo url('admin/view/index'); ?>" class="J_menuItem">消息提示<span class="layui-badge"  style="position: relative;display: inline-block;padding: 0 6px;font-size: 12px;text-align: center;background-color: #FF5722;color: #fff;border-radius: 2px;"><?php echo $viewopen['add']; ?></span></a>
                      </li>
